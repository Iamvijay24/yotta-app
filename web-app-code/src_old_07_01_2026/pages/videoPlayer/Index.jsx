...
const VideoPlayer = ({
  ...
  const loadedThumbnailRef = useRef(new Set());
  ...
  useEffect(() => {
    const handleVisibilityChange = () => {
      if (document.hidden) {
        setWasPlayingBeforeHide(playerState.isPlaying);
  ...
  }, [playerState.isPlaying, controls, wasPlayingBeforeHide]);
    ...
    <div className={styles.contentSectionWrapper}>
      ...
      >
        ...
        <VideoThumbnail
          ...
          onPlay={handlePlay}
          topicId={topicId}
          loadedThumbnailRef={loadedThumbnailRef}
        />
        {/* Loading overlay */}
