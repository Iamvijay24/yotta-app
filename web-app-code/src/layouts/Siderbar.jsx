...
import { Menu, Avatar, Button, Typography, Tooltip } from 'antd';
...
const Sidebar = ({ collapsed, setCollapsed }) => {
  ...
  const initials = (names[0]?.charAt(0) || 'U') + (names[1]?.charAt(0) || '');
  const avatarStyle = {
    background: 'linear-gradient(135deg, #1283a9ff 100%)',
    color: 'white',
  };
  return (
    <>
