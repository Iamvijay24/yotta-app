// shared/api/AuthContext.jsx (updated - map given_name to name, add updateAttributes, fix region in pool if needed but kept as is)
...
export const AuthProvider = ({ children }) => {
  ...
  const logout = () => {
    ...
    localStorage.removeItem('authToken'); // Clean up simulated Google login storage
    localStorage.removeItem('user'); // Clean up simulated Google login storage
  };
