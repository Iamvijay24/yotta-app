...
const VideoPlayer = ({
  ...
  }, [handlePlay, handleSkipBackward, handleSkipForward, handleFullScreen, controls, showControlsTemporarily]);
  ...
  useEffect(() => {
    ...
    script.src = 'https://facebot-videos.s3.us-west-2.amazonaws.com/script/ai_widget.js';
    script.async = true;
  ...
  const handleAiTutor = useCallback(async() => {
    try {
      ...
      const fbId = 'facebot';
      const partnerId = 'facebot';
      await window.ai_tutor.init(fbId, partnerId, currentLessonId);
